    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ProductActivity.this,Rate.class);
    ...
    private void onOrderProduct() {
        bOrder.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                common.qty = Integer.valueOf(spQuantity.getSelectedItem().toString());

                common.productname.add(product.getName());
                common.pqty.add(spQuantity.getSelectedItem().toString());
                Intent intent = new Intent(ProductActivity.this, ShoppingCartActivity.class);
                startActivity(intent);
