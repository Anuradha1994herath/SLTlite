...
public class ShoppingCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new AlertDialog.Builder(ShoppingCartActivity.this)
                        ...
                        .setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                cart.remove((Saleable) cartItems.get(position-1).getProduct());
        ...
        lvCartItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ShoppingCartActivity.this, com.example.acer.slt_lite.ProductActivity.class);
        ...
        pay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                common.price = cart.getTotalPrice();
    ...
    public class GetDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(ShoppingCartActivity.this,common.idew, Toast.LENGTH_SHORT).show();


            new PutDataTask().execute("http://192.168.8.101:4000/apii/editstore/"+common.idew.trim(),"yes");
                ...
                try {
                    ...
                    for (int i =0; i<ja.length();i++){
                        ...
                        if(jo.get("item").toString().equals(nn)){
                            common.qqqe = (Integer) jo.get("qty");
                            common.sold = (Integer) jo.get("soldqty");
                            common.idew= (String) jo.get("_id");
    ...
    class PutDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            common.newq  =  common.qqqe - common.qty;
            common.newsold = common.sold + common.qty;
        ...
        private String putData(String urlPath) throws IOException, JSONException {
            ...
            try {
                ...
                dataToSend.put("qty", common.newq);
                dataToSend.put("soldqty", common.newsold);
