...
public class mmmmm extends AppCompatActivity {
      ...
      //  mResult = (TextView) findViewById(R.id.tv_result);
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new GetDataTask().execute("http://192.168.83.1:4000/apii/viewcuz",User.getText().toString(),Password.getText().toString().trim());
    ...
    public class GetDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(mmmmm.this,common.iid, Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                try {
                    ...
                    for (int i =0; i<ja.length();i++){
                        ...
                        if(jo.get("firstname").toString().equals(nn) && jo.get("subarea").toString().equals(ac)){
                            kkk = "true";
                            common.iid = (String) jo.get("_id");
                            common.fname = (String) jo.get("firstname");
