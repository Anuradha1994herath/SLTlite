...
public class MainActivity extends AppCompatActivity  implements OnSliderClickListener,
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.ic_books:
                        Intent intent2 = new Intent(MainActivity.this, storeMainActivity.class);
                    ...
                    case R.id.ic_backup:
                        Intent intent4 = new Intent(MainActivity.this, cuzzmappp.class);
