...
public class storeMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x=1;
        new GetDataTask().execute("http://192.168.83.1:4000/apii/viewstore");
    ...
    public class GetDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(storeMainActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            */
            ...
            ProductAdapter productAdapter = new ProductAdapter(storeMainActivity.this);
            ...
            lvProducts.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent intent = new Intent(storeMainActivity.this, com.android.tonyvu.sc.demo.ProductActivity.class);
            ...
            Toast.makeText(storeMainActivity.this,descr,Toast.LENGTH_SHORT).show();
